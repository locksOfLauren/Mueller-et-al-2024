function [out] = Cortex_cluster_McKenzie_test_dend(sd,varargin);
...
[cellResponses] = LM_McKenzie_medianFr_Odor032924_17_NComms(sd);
...
uid_PL = zeros(length(HF_PL),1)%lower firing NS
...
for i = 1:length(HF_PL);%higher firing NS
    if HF_PL(i) == 1 & PL_avgFr(i,1) < 10 ;
       HF_PL(i)=0;
    end
end
